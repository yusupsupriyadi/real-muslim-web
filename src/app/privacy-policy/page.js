        ...
        <main className='mx-auto px-10 py-10'>
            <section className="flex justify-center">
                <div>
                    ...
                    <p className="text-xs text-white/80 mt-2 text-center">© 2023 YSTUDIO. All rights reserved.</p>
                </div>
            </section>
            <section className="text-white mt-10">
                <h1>Privacy Policy for Real Muslim</h1>
                <p>
                    At Real Muslim, accessible from https://real-muslim.vercel.app/, one of our
                    main priorities is the privacy of our visitors. This Privacy Policy document
                    contains types of information that is collected and recorded by Real Muslim
                    and how we use it.
                </p>
                <p>
                ...
                <p>
                    Real Muslim follows a standard procedure of using log files. These files log
                ...
                <p>
                    ...
                    advertising partners of Real Muslim.
                </p>
                <p>
                    Third-party ad servers or ad networks uses technologies like cookies,
                    JavaScript, or Web Beacons that are used in their respective advertisements
                    and links that appear on Real Muslim, which are sent directly to users'
                ...
                <p>
                    Note that Real Muslim has no access to or control over these cookies that
                    are used by third-party advertisers.
                </p>
                <h2 className="mt-4">Third Party Privacy Policies</h2>
                <p>
                    Real Muslim's Privacy Policy does not apply to other advertisers or
                ...
                <p>
                    Real Muslim does not knowingly collect any Personal Identifiable Information
                    from children under the age of 13. If you think that your child provided
                    this kind of information on our website, we strongly encourage you to
                    contact us immediately and we will do our best efforts to promptly remove
                    such information from our records.
                </p>
                <h2 className="mt-4">Online Privacy Policy Only</h2>
                <p>
                    This Privacy Policy applies only to our online activities and is valid for
                    visitors to our website with regards to the information that they shared
                    and/or collect in Real Muslim. This policy is not applicable to any
